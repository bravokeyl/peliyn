<article <?php hybrid_attr( 'post' ); ?>>
	...
	<?php else : // If not viewing a single post. ?>
		...
		<?php get_the_image( array( 'size' => 'peliyn-full' ) ); ?>
		...
		<div <?php hybrid_attr( 'entry-summary' ); ?>>
			...
			<p class="gallery-count"><?php printf( _n( 'This gallery contains %s item.', 'This gallery contains %s items.', $count, 'peliyn' ), $count ); ?></p>
		</div><!-- .entry-summary -->
