	...
	<?php if ( is_attachment() ) : // If viewing a single attachment. ?>
		...
		<header class="entry-header">
			...
			<div class="entry-byline">
				<span class="image-sizes"><?php printf( __( 'Sizes: %s', 'peliyn' ), hybrid_get_image_size_links() ); ?></span>
			</div><!-- .entry-byline -->
...
<?php if ( is_attachment() ) : // If viewing a single attachment. ?>
	...
	<div class="attachment-meta">
		...
		<div class="media-info image-info">
			...
			<h3 class="attachment-meta-title"><?php _e( 'Image Info', 'peliyn' ); ?></h3>
		...
		<?php if ( !empty( $gallery ) ) : // Check if the gallery is not empty. ?>
			...
			<div class="image-gallery">
				<h3 class="attachment-meta-title"><?php _e( 'Gallery', 'peliyn' ); ?></h3>
				<?php echo $gallery; ?>
			</div>
