<article <?php hybrid_attr( 'post' ); ?>>
	...
	<?php if ( is_singular( get_post_type() ) ) : // If viewing a single post. ?>
		...
		<footer class="entry-footer">
			...
			<?php hybrid_post_terms( array( 'taxonomy' => 'category', 'text' => __( '<i class="fa fa-folder-open"></i> %s ', 'peliyn' ), 'before' => ''  ) ); ?>
			<?php hybrid_post_terms( array( 'taxonomy' => 'post_tag', 'text' => __( '<i class="fa fa-tags"></i> %s', 'peliyn' ), 'before' => '' ) ); ?>
		</footer><!-- .entry-footer -->
